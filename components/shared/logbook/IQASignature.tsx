...
export function IQASignature() {
  ...
  return (
    <div className="p-10">
      <div className="p-2">
        {
          workbook?.logbook?.iqa?.signature?.length ?
          <Image className="m-auto" src={String(workbook.logbook.iqa.signature)} width={300} height={200} alt="IQA Signature" /> : ''
        }
        {
          workbook?.logbook?.iqa &&
          <div className="text-right">
            <Dialog open={openDialog} onOpenChange={setopenDialog}>
              ...
              <DialogContent className="sm:max-w-[425px]">
                ...
                <div className="text-center"><b>{workbook?.logbook?.iqa?.name}</b></div>
                <DialogFooter>
      ...
      <div>
        {workbook?.logbook?.iqa?.signatureDate}
      </div>
      <div className="border-t-2 border-black">
        {workbook?.logbook?.iqa?.name}
        <b><br /> IQA</b>
      </div>
    </div>
  )
