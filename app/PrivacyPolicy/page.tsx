export default function PrivacyPolicy() {
  return(
    <div className="bg-white m-auto my-4 p-4" style={{maxWidth: '720px' }}>
      ...
      <div className="py-5">Version 1.2  -  Mar 04 2025 <br /> Review Date: Mar 04 2026</div>
      ...
      <ul>
          ...
          <li><strong>Data Transmission & Encryption:</strong> All interactions with Google Drive are encrypted using industry-standard HTTPS/TLS.</li>
      </ul>

      <h2 className="text-2xl py-5">4. Sensitive Data Protection & Security Measures</h2>
      <p>We understand the importance of protecting sensitive user data. However, our application <strong>does not collect, store, or process</strong> sensitive user data. We ensure data security through the following measures:</p>
      <ul>
          <li>Files remain entirely within Google Drive and are never transferred or stored on external servers.</li>
          ...
          <li>Users can manage or revoke access at any time through <a href="https://myaccount.google.com/permissions" target="_blank">Google Account Permissions</a>.</li>
          <li>We follow Google&apos;s API security guidelines and comply with Google&apos;s data privacy policies.</li>
      </ul>
